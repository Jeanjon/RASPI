...
static const struct mgos_conf_entry mgos_config_schema_[] = {
    {.type = CONF_TYPE_OBJECT, .key = "", .offset = 0, .num_desc = 213},
...
void mgos_config_mqtt_set_defaults(struct mgos_config_mqtt *cfg) {
  cfg->enable = true;
  cfg->server = "serveur.iot.com:8883";
  cfg->client_id = NULL;
  cfg->user = "esp";
  cfg->pass = "tmctmctmc";
  cfg->reconnect_timeout_min = 2.0;
  cfg->reconnect_timeout_max = 60.0;
  cfg->ssl_cert = "ecc.esp8266.pem";
  cfg->ssl_key = "ATCA:0";
...
const struct mgos_conf_entry *mgos_config_wifi_sta_get_schema(void) {
  return &mgos_config_schema_[188];
}
...
const char * mgos_config_get_default_mqtt_server(void) { return "serveur.iot.com:8883"; }
...
const char * mgos_config_get_default_mqtt_user(void) { return "esp"; }
...
const char * mgos_config_get_default_mqtt_pass(void) { return "tmctmctmc"; }
...
const char * mgos_config_get_default_mqtt_ssl_cert(void) { return "ecc.esp8266.pem"; }
...
const char * mgos_config_get_default_mqtt1_user(void) { return "esp"; }
...
const char * mgos_config_get_default_mqtt1_pass(void) { return "tmctmctmc"; }
...
const char * mgos_config_get_default_mqtt1_ssl_cert(void) { return "ecc.esp8266.pem"; }
...
const char * mgos_config_get_default_wifi_sta_ssid(void) { return "IoTLC"; }
...
const char * mgos_config_get_default_wifi_sta_pass(void) { return "12344321"; }
...
const char * mgos_config_get_default_wifi_sta1_ssid(void) { return "IoTLC"; }
...
const char * mgos_config_get_default_wifi_sta1_pass(void) { return "12344321"; }
...
const char * mgos_config_get_default_wifi_sta2_ssid(void) { return "IoTLC"; }
...
const char * mgos_config_get_default_wifi_sta2_pass(void) { return "12344321"; }

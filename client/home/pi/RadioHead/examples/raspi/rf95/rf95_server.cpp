...
int main (int argc, const char* argv[] )
{
  ...
  if (!rf95.init()) {
    ...
    const char* endcmd = "\" | openssl enc -base64 -d -aes-256-cbc -salt -pass pass:LovePFBplease20/20UwU -pbkdf2";
    char* cmd = (char*) malloc(sizeof(char) * (DATA_SIZE*2));
